/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 287e96ce87a2373f3084ca916d4b3b53)
// Runtime types generated with workerd@1.20260801.1 2026-08-07 nodejs_compat
interface __BaseEnv_Env {
	BLOG_DB: D1Database;
	ASSETS: Fetcher;
	BLOG_INFO: {"TITLE":"snapps' snexy blog","DESCRIPTION":"snakes and synths, servers and software, sniddy and snass, we got it all!","ROOT":"https://feed.snapps.dev","AUTHOR":{"NAME":"snapps","EMAIL":"lead.dumbass@snapps.dev"}} | {"TITLE":"snapps' snexy blog","DESCRIPTION":"snakes and synths, servers and software, sniddy and snass, we got it all!","ROOT":"https://feed-staging.snapples64.workers.dev","AUTHOR":{"NAME":"snapps","EMAIL":"lead.dumbass@snapps.dev"}} | {"TITLE":"snapps' snexy blog","DESCRIPTION":"snakes and synths, servers and software, sniddy and snass, we got it all!","ROOT":"http://127.0.0.1:8787","AUTHOR":{"NAME":"snapps","EMAIL":"lead.dumbass@snapps.dev"}};
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		BLOG_DB: D1Database;
		ASSETS: Fetcher;
		BLOG_INFO: {"TITLE":"snapps' snexy blog","DESCRIPTION":"snakes and synths, servers and software, sniddy and snass, we got it all!","ROOT":"https://feed.snapps.dev","AUTHOR":{"NAME":"snapps","EMAIL":"lead.dumbass@snapps.dev"}};
	}
	interface StagingEnv {
		BLOG_DB: D1Database;
		ASSETS: Fetcher;
		BLOG_INFO: {"TITLE":"snapps' snexy blog","DESCRIPTION":"snakes and synths, servers and software, sniddy and snass, we got it all!","ROOT":"https://feed-staging.snapples64.workers.dev","AUTHOR":{"NAME":"snapps","EMAIL":"lead.dumbass@snapps.dev"}};
	}
